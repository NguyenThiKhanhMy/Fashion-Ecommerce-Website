...
import {createCategory,getAProductCategory,resetState,updateAProductCategory,} from "../features/productCategory/productCategorySlice";
  ...
  return (
    <div>
      <h3 className="mb-4  title">
        {getPCatId !== undefined ? "Sửa" : "Thêm"} danh mục hàng hóa
      </h3>
      <div>
